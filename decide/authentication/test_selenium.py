...
class AdminTestCase(StaticLiveServerTestCase):
    ...
    # Test creado en la practica 2 por mi con SeleniumIDE
    def test_login(self):
        #self.driver.get("http://localhost:8000/admin/login/?next=/admin/")
        self.driver.get(f'{self.live_server_url}/admin/')
        self.driver.find_element(By.ID, "id_username").send_keys("practica")
        self.driver.find_element(By.ID, "id_password").send_keys("practica")
